...
module.exports = {
  ...
  hashPassword: (plain, algorithm = 'argon2', algParam = undefined) => {
    ...
    console.error('algorithm not supported!'); // eslint-disable-line no-console
    return Promise.reject('algorithm not supported!'); // TODO: convert to 'new Error' and create own error type
  },
